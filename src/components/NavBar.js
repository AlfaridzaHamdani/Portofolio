...
const NavBar = () => {
  ...
  return (
    <header className="w-full px-32 py-8 font-medium flex items-center justify-between dark:text-light z-10 lg:px-16 md:py-12 lg:py-10 sm:px-8">
      <button
      ...
      <div className="w-full flex justify-between items-center lg:hidden">
        <nav>
          ...
          <CustomLink href="/articles" title="Article" className="mr-4" />
        </nav>

        <nav className="flex items-center justify-center flex-wrap ">
          <motion.a
            href="https://twitter.com/notalll_"
            target="_blank"
            whileHover={{ y: -2 }}
            className="w-6 mr-3"
          >
          ...
          <motion.a
            href="https://github.com/AlfaridzaHamdani"
            target="_blank"
            whileHover={{ y: -2 }}
            className="w-6 mx-3"
          >
        ...
        className="min-w-[70vw] flex flex-col justify-between items-center fixed top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 z-30 bg-dark/90 dark:bg-light/90 rounded-lg backdrop-blur-md py-32">
          ...
          <nav className="flex items-center justify-center flex-wrap mt-2">
            ...
            <motion.a
              ...
              whileHover={{ y: -2 }}
              whileTap={{ scale: 0.9 }}
              className="w-6 mx-3 bg-light rounded-full dark:bg-dark mr-3 sm:mx-1"
            >
              <GithubIcon />
            </motion.a>
            <motion.a
