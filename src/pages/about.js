...
import profilePict from "../../public/images/profile/pict.png";
...
const about = () => {
  return (
    <>
      <Head>
        <title>Alfaridza | About Page</title>
      ...
      <main className="flex w-full flex-col items-center justify-center dark:text-light">
        <Layout className="pt-16">
          ...
          />
          <div className="grid w-full grid-cols-8 gap-16 md:grid-cols-4 sm:gap-8 md:flex md:flex-col">
            <div className="col-span-3 xl:col-span-4 flex flex-col items-start justify-start md:order-2 md:col-span-8">
              ...
              <p className="font-medium dark:text-light">
                I am Alfaridza. My interest in the world of technology has
                inspired me to explore and understand more about programming and
                web development.
              </p>
              <p className="my-4 font-medium dark:text-light">
                Now I am pursuing my education at Telkom University, majoring in
                Application Software Engineering.
              </p>
              <p className="font-medium dark:text-light">
                I am committed to continually growing and providing the best
                solutions.
              </p>
            </div>
